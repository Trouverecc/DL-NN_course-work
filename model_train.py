...
import os
os.environ["TF_CPP_MIN_LOG_LEVEL"] = "0"    #只显示error信息
...
def train_model_process(model, train_dataloader, val_dataloader, num_epochs):
    ...
    # SGD优化器
    # optimizer = torch.optim.SGD(model.parameters(), lr=0.001, momentum=0.9)  # 动量0.9
    # RMSprop优化器
    # optimizer = torch.optim.RMSprop(model.parameters(), lr=0.001, alpha=0.9)  # 动量0.9
    # AdaDelta优化器
    optimizer = torch.optim.Adadelta(model.parameters(), rho=0.9, eps=1e-06)
    ...
    torch.save(best_model_wts, 'D:/pythonProject/lesson3A/LeNet/best_model.pth')
...
if __name__=="__main__":
    ...
    train_process = train_model_process(LeNet, train_dataloader, val_dataloader,20)#20轮
...
#     LeNet = LeNet()
#     train_dataloader,val_dataloader = train_val_data_process()
#     train_process = train_model_process(LeNet, train_dataloader, val_dataloader,20)#10轮
#     matplot_acc_loss(train_process)